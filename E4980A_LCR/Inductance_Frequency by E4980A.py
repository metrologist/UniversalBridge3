# For evaulating the frequency impacts on inductance
# adapted from K4980A_L_R.py
# frequencies at % of 10k omega = {
#     0.9: 1432.4,
#     0.95: 1512.4,
#     1.0: 1591.5,
#     1.05: 1670.8,
#     1.1: 1749.6
# }
# frequencies as the list = [1432.4, 1512.4, 1591.5, 1670.8, 1749.6]
#
...
Resistor_description = input('Cable and Device name :')
prile('Name and description of Device under test: ', Resistor_description)
...
freq_list = [1432.4, 1512.4, 1591.5, 1670.8, 1749.6]# take readings of three frequency points only
prile("select the freq range 90% - 110%", freq_list)
